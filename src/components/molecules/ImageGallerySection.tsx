...
import subtractImage from './Subtract.png';
import galleryImage from './image.png';

interface ImageModule {
  src: string;
}

const resolveImageSrc = (image: string | ImageModule): string =>
  ...
  return (
    <div className="flex h-full items-center justify-center">
      <div
        ...
        style={{
          backgroundImage: `url(${resolveImageSrc(subtractImage)})`,
        }}
      >
        ...
        <div
          ...
          style={{
            backgroundImage: `url(${resolveImageSrc(galleryImage)})`,
          }}
        />
        ...
        <div className="absolute top-[330px] left-[90px] z-[2] h-[117px] w-[209px] rounded-lg bg-[#ED632F] p-3">
          <span className="flex items-center gap-2">
            <div>
              <p className="text-[46px] font-bold leading-none text-white">50</p>
            </div>
