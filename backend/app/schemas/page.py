...
slug_validator = validate.Regexp(
    r"^[a-z0-9]+(?:-[a-z0-9]+)*$", error="Use apenas slugs em-kebab-case."
)
...
class PageSchema(Schema):
    ...
    slug = fields.Str(
        load_default=None,
        allow_none=True,
        validate=[validate.Length(min=2), slug_validator],
    )
    ...
    sections = fields.List(fields.Dict(), load_default=None, allow_none=True)
